...
Over `r round(eda$opinion$stats$Cumulative[1] * 100, 0)`% of all respondents since 1972 held the traditional view that extra-marital conduct was wrong or almost always wrong. Granted, over `r round(eda$period$stats$Proportion[1] * 100, -1)`% of
...
```{r age1Plot, echo = F, message = FALSE, warning=FALSE, results = 'html'}
age1$plots$observed
```
...
```{r age2Plot, echo = F, message = FALSE, warning=FALSE}
age2$plots$observed
```
...
```{r age3Plot, echo = F, message = FALSE, warning=FALSE}
age3$plots$observed
```
...
```{r age4Plot, echo = F, message = FALSE, warning=FALSE}
...
```{r gender1Plot, echo = F, message = FALSE, warning=FALSE}
...
```{r gender2Plot, echo = F, message = FALSE, warning=FALSE}
...
```{r educ1Plot, echo = F, messeduc = FALSE, warning=FALSE}
...
```{r educ2Plot, echo = F, messeduc = FALSE, warning=FALSE}
...
```{r educ3Plot, echo = F, messeduc = FALSE, warning=FALSE}
...
```{r educ4Plot, echo = F, messeduc = FALSE, warning=FALSE}
...
```{r educ5Plot, echo = F, messeduc = FALSE, warning=FALSE}
...
```{r educ5ZTest, echo = F, results='html'}
...
```{r region1Plot, echo = F, message = FALSE, warning=FALSE}
...
```{r region2Plot, echo = F, message = FALSE, warning=FALSE}
...
```{r region3Plot, echo = F, message = FALSE, warning=FALSE}
...
```{r region4Plot, echo = F, message = FALSE, warning=FALSE}
...
```{r region5Plot, echo = F, message = FALSE, warning=FALSE}
...
```{r educDisc, echo = F, results='html'}
knitr::kable(educDiscussion$data, align = c("l", rep("c", 4))) %>%  
  kableExtra::kable_styling(bootstrap_options = c("striped", "condensed"), full_width = T, position = "center")
``` 

```{r educPlot, echo = F, message = FALSE, warning=FALSE}
educDiscussion$plot
```
