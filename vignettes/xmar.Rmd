...
Confidence intervals for the differences in proportion of liberal opinion were computed.
...
As indicated above and confirmed in `r kfigr::figr(label = "rq1X2TestData", prefix = TRUE, link = TRUE, type="Table")`,  the association was significant, $X^2$(`r rqaResults$age$x2Test$table$Df`, $N = $`r rqaResults$age$x2Test$table$N`) = `r rqaResults$age$x2Test$table$X2_Observed`.
