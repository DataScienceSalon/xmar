...
2. **Success/Failure:** There must be at least 10 successes and 10 failures for dichotomous categorical variables.  As shown in `r kfigr::figr(label = "rq1Plot", prefix = TRUE, link = TRUE, type="Figure")`, the number of conservative and liberal opinions far exceed this minimum threshold.   
...
`r rqaResults$age$zTest[[1]]$stmt$type` 

`r kfigr::figr(label = "rq1aZTest", prefix = TRUE, link = TRUE, type="Table")`: Two-Proportion Z-Test of Opinion between age groups `r rqaResults$age$zTest[[1]]$df$Group`
```{r rq1aZTest, echo = F, results='html'}
knitr::kable(rqaResults$age$zTest[[1]]$df) %>%  
  kableExtra::kable_styling(bootstrap_options = c("striped", "condensed"), full_width = T, position = "center")
``` 
where:  
* `r rqaResults$age$zTest[[1]]$footnote[[1]]`  
* `r rqaResults$age$zTest[[1]]$footnote[[2]]`  
* `r rqaResults$age$zTest[[1]]$footnote[[3]]`  
* `r rqaResults$age$zTest[[1]]$footnote[[4]]`  
* `r rqaResults$age$zTest[[1]]$footnote[[5]]`  
* `r rqaResults$age$zTest[[1]]$footnote[[6]]`  
* `r rqaResults$age$zTest[[1]]$footnote[[7]]`   
* `r rqaResults$age$zTest[[1]]$footnote[[8]]`   
* `r rqaResults$age$zTest[[1]]$footnote[[9]]`    
* `r rqaResults$age$zTest[[1]]$footnote[[10]]`  
* `r rqaResults$age$zTest[[1]]$footnote[[11]]`  

As indicated in `r kfigr::figr(label = "rq1aZTest", prefix = TRUE, link = TRUE, type="Table")`, `r  rqaResults$age$zTest[[1]]$stmt$detail`  

`r rqaResults$age$zTest[[1]]$stmt$conclude`
...
`r rqaResults$age$zTest[[2]]$stmt$type` 

`r kfigr::figr(label = "rq1bZTest", prefix = TRUE, link = TRUE, type="Table")`: Two-Proportion Z-Test of Opinion between age groups `r rqaResults$age$zTest[[2]]$df$Group`
```{r rq1bZTest, echo = F, results='html'}
knitr::kable(rqaResults$age$zTest[[2]]$df) %>%  
  kableExtra::kable_styling(bootstrap_options = c("striped", "condensed"), full_width = T, position = "center")
``` 
where:  
* `r rqaResults$age$zTest[[2]]$footnote[[1]]`  
* `r rqaResults$age$zTest[[2]]$footnote[[2]]`  
* `r rqaResults$age$zTest[[2]]$footnote[[3]]`  
* `r rqaResults$age$zTest[[2]]$footnote[[4]]`  
* `r rqaResults$age$zTest[[2]]$footnote[[5]]`  
* `r rqaResults$age$zTest[[2]]$footnote[[6]]`  
* `r rqaResults$age$zTest[[2]]$footnote[[7]]`   
* `r rqaResults$age$zTest[[2]]$footnote[[8]]`   
* `r rqaResults$age$zTest[[2]]$footnote[[9]]`    
* `r rqaResults$age$zTest[[2]]$footnote[[10]]`  
* `r rqaResults$age$zTest[[2]]$footnote[[11]]`  

As indicated in `r kfigr::figr(label = "rq1bZTest", prefix = TRUE, link = TRUE, type="Table")`, `r  rqaResults$age$zTest[[2]]$stmt$detail`  

`r rqaResults$age$zTest[[2]]$stmt$conclude`
...
`r rqaResults$age$zTest[[3]]$stmt$type` 

`r kfigr::figr(label = "rq1cZTest", prefix = TRUE, link = TRUE, type="Table")`: Two-Proportion Z-Test of Opinion between age groups `r rqaResults$age$zTest[[3]]$df$Group`
```{r rq1cZTest, echo = F, results='html'}
knitr::kable(rqaResults$age$zTest[[3]]$df) %>%  
  kableExtra::kable_styling(bootstrap_options = c("striped", "condensed"), full_width = T, position = "center")
``` 
where:  
* `r rqaResults$age$zTest[[3]]$footnote[[1]]`  
* `r rqaResults$age$zTest[[3]]$footnote[[2]]`  
* `r rqaResults$age$zTest[[3]]$footnote[[3]]`  
* `r rqaResults$age$zTest[[3]]$footnote[[4]]`  
* `r rqaResults$age$zTest[[3]]$footnote[[5]]`  
* `r rqaResults$age$zTest[[3]]$footnote[[6]]`  
* `r rqaResults$age$zTest[[3]]$footnote[[7]]`   
* `r rqaResults$age$zTest[[3]]$footnote[[8]]`   
* `r rqaResults$age$zTest[[3]]$footnote[[9]]`    
* `r rqaResults$age$zTest[[3]]$footnote[[10]]`  
* `r rqaResults$age$zTest[[3]]$footnote[[11]]`  

As indicated in `r kfigr::figr(label = "rq1cZTest", prefix = TRUE, link = TRUE, type="Table")`, `r  rqaResults$age$zTest[[3]]$stmt$detail`  

`r rqaResults$age$zTest[[3]]$stmt$conclude`
...
df <- rbind(rqaResults$age$zTest[[1]]$df, rqaResults$age$zTest[[2]]$df, rqaResults$age$zTest[[3]]$df)
knitr::kable(df) %>%  
  kableExtra::kable_styling(bootstrap_options = c("striped", "condensed"), full_width = T, position = "center")
``` 
...
#### Test results 
`r rqaResults$gender$zTest[[1]]$stmt$type` 

`r kfigr::figr(label = "rq2ZTest", prefix = TRUE, link = TRUE, type="Table")`: Two-proportion z-test of opinion by gender
```{r rq2ZTest, echo = F, results='html'}
knitr::kable(rqaResults$gender$zTest[[1]]$df) %>%  
  kableExtra::kable_styling(bootstrap_options = c("striped", "condensed"), full_width = T, position = "center")
``` 
where:  
* `r rqaResults$age$zTest[[1]]$footnote[[1]]`  
...
As indicated in `r kfigr::figr(label = "rq2ZTest", prefix = TRUE, link = TRUE, type="Table")`, `r  rqaResults$gender$zTest[[1]]$stmt$detail`  

`r rqaResults$gender$zTest[[1]]$stmt$conclude`
