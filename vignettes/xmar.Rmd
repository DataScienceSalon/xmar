...
#### Data
The observed (`r kfigr::figr(label = "ageObservedPlot", prefix = TRUE, link = TRUE, type="Figure")`) and expected frequencies (`r kfigr::figr(label = "ageExpectedPlot", prefix = TRUE, link = TRUE, type="Figure")`) of opinion by age group indicated a trend towards more conservative views with increasing age. 
...
### Research Question 2: Opinions by Gender and Age
```{r genderAnalysis, echo = F, message = FALSE, warning=FALSE}
data3d <- xmar %>% select(Opinion, Gender, AgeGroup)
genderAge <- analyze3d(data3d)
```
